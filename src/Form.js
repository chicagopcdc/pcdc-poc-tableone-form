  ...
  return (
    ...
    <label>
      ...
      <input
        ...
        onChange={(e) => this.props.handleChangeGroupingVariable(e, 'value')}
      />
    </label>
    <br />
    ...
    <label>
      ...
      <input
        ...
        onChange={(e) => this.props.handleChangeGroupingVariable(e, 'false')}
      />
    </label>
    <br />
        ...
        <div key={index}>
          ...
          <label>
            ...
            <select
              ...
              onChange={(e) => this.props.handletypeChange(e, index, 'type')}
            >
            ...
            <>
              <label>
                ...
                <input
                  ...
                  onChange={(e) =>
                    this.props.handleCovariateChange(e, index, 'cutoffs')
                  }
                />
              </label>
              <br />
            ...
            <>
              <label>
                ...
                <input
                  ...
                  onChange={(e) =>
                    this.props.handleCovariateChange(e, index, 'values')
                  }
                />
              </label>
              <br />
